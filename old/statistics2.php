...
while($query_data = mysql_fetch_row($child_result))
{
	...
	if ($sex == "Male") $num_boys += 1;
	if ($sex == "Female") $num_girls += 1;
}
...
echo "Current diaper amounts by sizes on the database." . "<br>";
echo "Size0: " . $size0 . "<br>";
echo "Size1: " . $size1 . "<br>";
echo "Size2: " . $size2 . "<br>";
echo "Size3: " . $size3 . "<br>";
...
echo "Additional Statistics:" . "<br>";
echo "Total amount of X in database: " . "<br>";
...
echo "<br>";
echo "Number of families that came per month<br>";
