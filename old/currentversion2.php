...
<!--logout button -->
<div class="button">
<button onclick="location.href = '/index.html';" id="myButton" class="float-left submit-button">Logout</button>
<button onclick="location.href = '/georgeversion.php';" id="myButton" class="float-left submit-button">testing</button>
